...
const Kanban = () => {
  ...
  const handleSubmit = (e) => {
    ...
    // Add the new task to the submitted tasks
  ...
  useEffect(() => {
    if (editingTaskId !== null) {
      const task = submittedtask.find((task) => task.id === editingTaskId);
      if (task) {
        setStatus(task.Status);
        // Other fields to be pre-filled can be added similarly
      }
    }
  }, [editingTaskId, submittedtask]);
            ...
            <Box sx={{ mb: 2 , width: "100%"}}>
              <LocalizationProvider dateAdapter={AdapterDayjs} label>
                <DatePicker
                  ...
                  sx={{
                    width: "100%", // Adjusting the width to match the TextField
                    "& .MuiOutlinedInput-root.Mui-focused .MuiOutlinedInput-notchedOutline":
                      {
                        borderColor: "#868dfb",
                      },
      ...
      <div className="container">
        <div className="d-flex">
          ...
          <div className="col">
            ...
            >
              <div className="card-body">
                <h3 style={{ color: colors.grey[900] }}>Completed</h3>
                {submittedtask
